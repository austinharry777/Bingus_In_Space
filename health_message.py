...
health_bonus = pygame.mixer.Sound('sounds/healthbonus.wav')
health_bonus.set_volume(0.7)


class Health_Message(Base_State):
    ...
    def draw(self, display_surface):
        self.draw_text(display_surface, "YOU'VE UNLOCKED A HEALTH!", c.WINDOW_WIDTH/2, c.WINDOW_HEIGHT/2, c.WHITE)
        if self.done1 == True:
