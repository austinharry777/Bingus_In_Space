...
class Cutscene2(Base_State):
    def __init__(self, game, score, health):
        ...
        self.game = game
        self.load_assets() 
        self.bing_orig = "BINGUS ALMOST THERE."
        self.bing_orig1 = "BINGUS FIRST CAT ON MOON."
        self.bing_orig2 = "WHERE FLOPPA I KNOW?"
        self.bing_orig3 = "FLOPPA NOT HIMSELF."
        self.flop_orig = "FLOPPA CAN'T LET HAPPEN."
        self.flop_orig1 = "FLOPPA MAD AT BINGUS."
        self.flop_orig2 = "FLOPPA CAN'T REMEMBER."
        self.flop_orig3 = "FLOPPA NO FEEL SO GOOD."
    ...
    def update(self, dt, actions):
        ...
        if self.done9 == True:
            ...
            if self.fade.fade_complete == True:
                level3 = Level3(self.game, self.score, self.health)
                level3.enter_state()
